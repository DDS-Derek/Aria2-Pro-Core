...
[![LICENSE](https://img.shields.io/github/license/DDS-Derek/Aria2-Pro-Core?style=flat-square)](https://github.com/DDS-Derek/Aria2-Pro-Core/blob/master/LICENSE)
![GitHub All Releases](https://img.shields.io/github/downloads/DDS-Derek/Aria2-Pro-Core/total?label=Downlaods&style=flat-square&color=red)
[![GitHub Stars](https://img.shields.io/github/stars/DDS-Derek/Aria2-Pro-Core.svg?style=flat-square&label=Stars&logo=github)](https://github.com/DDS-Derek/Aria2-Pro-Core/stargazers)
[![GitHub forks](https://img.shields.io/github/forks/DDS-Derek/Aria2-Pro-Core.svg?style=flat-square&label=Forks&logo=github)](https://github.com/DDS-Derek/Aria2-Pro-Core/fork)
![GitHub Workflow Status](https://img.shields.io/github/workflow/status/DDS-Derek/Aria2-Pro-Core/Aria2%20Builder?label=Actions&logo=github&style=flat-square)

Aria2 static binaries for GNU/Linux with some powerful feature patches.

[![GitHub release (latest by date)](https://img.shields.io/github/v/release/DDS-Derek/Aria2-Pro-Core?style=for-the-badge)](https://github.com/DDS-Derek/Aria2-Pro-Core/releases/latest)
...
### Manual installation
```shell
wget https://github.com/DDS-Derek/Aria2-Pro-Core/releases/download/[version]/aria2-[version]-static-linux-[arch].tar.gz
...
```shell
git clone https://github.com/DDS-Derek/Aria2-Pro-Core
cd Aria2-Pro-Core
...
DOCKER_BUILDKIT=1 docker build \
    -o type=local,dest=. \
    github.com/DDS-Derek/Aria2-Pro-Core
```
...
[![GPLv3](https://www.gnu.org/graphics/gplv3-127x51.png)](https://github.com/DDS-Derek/Aria2-Pro-Core/blob/master/LICENSE)
